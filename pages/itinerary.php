...
try {
    ...
    foreach ($dias as $dia) {
        foreach ($dia['servicios'] as $orden => $servicio_grupo) {
            ...
            if (
                $servicio && $servicio['tipo_servicio'] == 'transporte' &&
...
<body>
    ...
    <section class="hero-section">
        <div class="hero-content">
            ...
            <h1 class="hero-title">Itinerario personalizado de <?= $duracion_dias ?>
                <?= $duracion_dias == 1 ? 'día' : 'días' ?></h1>
                    ...
                    <div class="overview-details">
                        ...
                        <div class="detail-item">
                            ...
                            <div class="detail-info">
                                <h4>Duración</h4>
                                <p><?= $duracion_dias ?>
                                    <?= $duracion_dias == 1 ? 'día increíble' : 'días increíbles' ?></p>
                            </div>
                        </div>
                    </div>
                                                    ...
                                                    <li class="location-item">
                                                        ...
                                                        <div class="location-details">
                                                            <div class="location-name">
                                                                <?= htmlspecialchars($ubicacion_sec['ubicacion']) ?></div>
                                    ...
                                    <div class="day-description">
                                        ...
                                        <?php if ($duracion > 1): ?>
                                            <div class="stay-info-box">
                                                <strong>Estancia Extendida:</strong> Estos servicios y actividades están disponibles
                                                durante toda tu estancia de <?= $duracion ?> días en
                                                <?= htmlspecialchars($dia['ubicacion']) ?>. Podrás disfrutar con total flexibilidad
                                                y sin prisas.
                                            </div>
                                        <?php endif; ?>
                                    </div>
                                                        ...
                                                        <div class="service-details">
                                                            ...
                                                            <div class="service-meta">
                                                                ...
                                                                <?php if ($servicio['tipo_servicio'] == 'transporte' && $servicio['medio_transporte']): ?>
                                                                    <span>
                                                                        <i
                                                                            class="<?= getServiceIcon('transporte', $servicio['medio_transporte']) ?>"></i>
                                                                ...
                                                                <div class="service-item alternativa">
                                                                    ...
                                                                    <?php if ($alternativa['imagen']): ?>
                                                                        <div class="service-image"
                                                                            ...
                                                                            onclick="showImage('<?= htmlspecialchars($alternativa['imagen']) ?>')">
                                                                        </div>
                                                                    <?php endif; ?>
                                                                </div>
                                                            <?php endforeach; ?>
                        ...
                        <div class="price-breakdown">
                            ...
                            <?php if ($precios['noches_incluidas'] > 0): ?>
                                <div class="nights-included">
                                    <i class="fas fa-bed"></i>
                                    <?= $precios['noches_incluidas'] ?>
                                    <?= $precios['noches_incluidas'] == 1 ? 'noche incluida' : 'noches incluidas' ?>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
